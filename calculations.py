...
def find_max(x,y):
    ...
    print(f"x_max {x_max[0]} y_max {y_max}\n")    
...
def find_half(x,y,y_max):
    ...
    print(f"x_max_half_min:{ x_max_half_min} x_max_half_max:{x_max_half_max}\n")
    
    x_max_half = (x_max_half_max - x_max_half_min)/2 + x_max_half_min  
    
    return x_max_half_min,x_max_half_max, x_max_half,  y_max_half

#Just calculations that I used in the voigt_profile.py file. This is basically finding the center point of the graph each time as it shifts, which the method I am using the called the "Full-Width-Half-Maximum" method. 
